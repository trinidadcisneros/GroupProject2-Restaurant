    ...
    d3.json("local.json", function(data) {
      ...
      var sumstat = d3.nest() // nest function allows to group the calculation per level of a factor
        ...
        .rollup(function(d) {
          q1 = d3.quantile(d.map(function(g) { return g.ave_cost;}).sort(d3.ascending),.25)
          median = d3.quantile(d.map(function(g) { return g.ave_cost;}).sort(d3.ascending),.5)
          q3 = d3.quantile(d.map(function(g) { return g.ave_cost;}).sort(d3.ascending),.75)
